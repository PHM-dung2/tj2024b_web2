...
public class RestController4 {
    ...
    // * @RequestBody: HTTP 요청 body의 'application/json' 타입 자료를 자바 타입으로 변환/매핑해주는 어노테이션
    // -> @RequestBody 도 생략하면 @ModelAttribute 적용되므로 body 매핑은 꼭 @RequestBody 작성한다.
    // -> @RequestParam 도 생략하면 @ModelAttribute 적용되지만 queryString 매핑은 @ModelAttribute 가능하므로 생략 가능하다.
    @PostMapping("/dopost1")
