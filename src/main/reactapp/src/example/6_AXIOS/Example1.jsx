...
// 1. 설치 : 프로젝트 최상위 폴더 내 터미널에서 'npm i axios'
// ~\tj2024b_web2\src\main\reactapp> npm i axios

// 2. 파일 상단에 inport axios form 'axios';
...
export default function Example1( props ){
    ...
    const onEvent3 = async () => {
        ...
        console.log('=============== [2 GET] ===============');
        const response2 = await axios.get('https://jsonplaceholder.typicode.com/posts/1'); // 매개변수 보내기 : path varible 방식
